...
const message =
  "👋 Привет! Это бот, с помощью которого можно:\n" +
  "🇨🇦 Узнать результаты последних выборок\n" +
  "📊 Посмотреть текущее распределение по баллам\n" +
  "🔔 Подписаться на уведомления об очередном раунде!\n\n" +
  "Подписывайтесь, пользуйтесь, оставляйте пожелания и предложения по улучшению: @CaImmigrationBot\n" +
  "Всем добра и удачи.";
